                  ...
                  >
                    ...
                    <div className="px-5 md:px-8 pt-5 md:pt-8">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <span className="flex-shrink-0 text-[9px] md:text-[10px] font-bold tracking-[0.1em] uppercase px-2.5 py-1 border border-[#39ff14]/20 bg-[#39ff14]/[0.05] text-[#39ff14]/60">
                          {ex.hours}
                        </span>
                      </div>
                    ...
                    {/* Media */}
                    <div className="mt-5 md:mt-6 border-t border-white/5">
                      <p className="px-5 md:px-8 pt-3 text-[9px] font-bold tracking-[0.2em] uppercase text-white/20">
                        {ex.media.caption}
                      </p>
